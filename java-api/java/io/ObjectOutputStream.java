...
* {@description.open}
     ...
     * {@description.close}  It writes the magic number and
...
* {@description.open}
     ...
     * significant difference between writing a String into the stream
     * {@description.close} as
...
* {@description.open}
     * Sets block data mode to the given mode (true == on, false == off)
         * and returns the previous mode value.  If the new mode
     * {@description.close} is the same as
