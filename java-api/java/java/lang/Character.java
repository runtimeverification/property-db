...
* {@description.open}
     ...
     * {@description.close}     * @return  the primitive {@code char} value represented by
     *          this object.
     */
...
* {@description.open}
     ...
     * specified {@code char}.
     * {@description.close}  The result is a string of length
     ...
     * <a href="http://www.unicode.org/glossary/#high_surrogate_code_unit">
     * Unicode high-surrogate code unit</a>
     * (also known as <i>leading-surrogate code unt</i>).
     *
...
* {@description.open}
     ...
     * {@description.close}     * <li>It has a value in a range defined by the UnicodeData file.
     * </ul>
     *
     * @param   codePoint the character (Unicode code point) to be tested.
     * @return  {@code true} if the character has a defined meaning
