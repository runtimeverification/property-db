...
* {@description.open}
     ...
     * node.  Returns the specified default
     * {@description.close} if there is no value associated
...
* {@description.open}
     ...
     * default
     * {@description.close} if there is no value associated with the key, the backing store
