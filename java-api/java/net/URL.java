...
* {@description.open}
     ...
     * enclosed in square brackets ({@code '['} and
...
* {@description.open}
     ...
     * to a URI.
     * {@description.close} However, some URLs that are not strictly in compliance
...
* {@description.open}
     ...
     * {@description.close}     * @param protocol the protocol to use
     */
