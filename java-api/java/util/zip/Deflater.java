...
* {@description.open}
     ...
     * {@description.close}     * @return true if the input data buffer is empty and setInput()
     * should be called in order to provide more input
     */
...
* {@description.open}
     ...
     * {@description.close}     * @return true if the end of the compressed data output stream has
     * been reached
     */
