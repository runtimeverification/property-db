...
public class PropertyLinkTaglet implements Taglet {
  private static final String NAME = "property.link";
    ...
    public static void register(Map tagletMap) {
       PropertyLinkTaglet tag = new PropertyLinkTaglet();
    ...
    public String toString(Tag tag) {
      return GenerateUrls.processPropertyLinkTag(tag);
    } 
    /**
