...
public class PropertyShortcutTaglet implements Taglet {
  private static final String NAME = "property.shortcut";
    ...
    public static void register(Map tagletMap) {
       PropertyShortcutTaglet tag = new PropertyShortcutTaglet();
